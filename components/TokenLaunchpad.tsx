...
export default function TokenLaunchpad({ onMintCreated }: Props) {
    ...
    return (
        <div className="relative max-w-md w-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-violet-700/20 via-violet-600/10 to-violet-500/20 rounded-3xl blur-xl"></div>
            <div className="relative bg-neutral-900/80 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl">

                {/* Header with icon */}
                <div className="text-center mb-8">
                    <h2 className="text-2xl font-bold bg-gradient-to-r from-violet-400 via-violet-300 to-violet-200 bg-clip-text text-transparent">
                        Create Your Token
                    </h2>
                ...
                <div className="space-y-6">
                            ...
                            <div key={label} className="group">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-neutral-800/50 backdrop-blur-sm text-white px-4 py-4 pl-12 rounded-2xl border border-neutral-700/50 placeholder:text-neutral-500 outline-none transition-all duration-300 focus:border-violet-500/50 focus:ring-2 focus:ring-violet-500/20 focus:bg-neutral-800/80 hover:border-neutral-600/50"
                                    ...
                                    />
                                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-neutral-500 group-focus-within:text-violet-400 transition-colors">
                    ...
                    <div className="group flex items-center justify-between w-full gap-x-3">
                        {tokenMetadata.imageUrl && (
                            <div className="flex justify-center">
                                <div className="relative w-24 h-24 rounded-2xl overflow-hidden border-2 border-violet-500/30 shadow-lg ring-4 ring-violet-500/10">
                                    <Image
                        ...
                        <div className="w-full">
                            ...
                            <div className="relative flex flex-row items-center">
                                ...
                                <label
                                    htmlFor="file"
                                    className="flex items-center justify-center w-full h-16 bg-neutral-800/50 backdrop-blur-sm border-2 border-dashed border-neutral-700/50 rounded-2xl cursor-pointer transition-all duration-300 hover:border-violet-500/50 hover:bg-neutral-800/80 group-hover:border-neutral-600/50">
                    ...
                    <button
                        onClick={createToken}
                        type="button"
                        className="w-full relative group bg-violet-500/90 hover:bg-violet-600 text-black font-semibold px-6 py-4 rounded-2xl transition-all active:scale-[0.98]"
                    >
                        <span className="relative z-10 flex items-center justify-center gap-2">
                            <Plus size={18} />
                            Create Token
                        </span>
                        <div className="absolute inset-0 rounded-md blur-sm opacity-30 group-hover:opacity-40 bg-violet-500"></div>
                    </button>
                </div>
            </div>
        </div>
